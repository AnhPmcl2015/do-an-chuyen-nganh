...
import { ACCESS_TOKEN, APP_LINK } from './../../constants/constants';
            ...
            <Drawer
                ...
                <section className="container-fluid">
                    <section className="row align-items-center">
                        ...
                        <Divider />
                        <section className="col-12"><Link to={APP_LINK.listJobs}>Việc làm</Link></section>
                        <Divider />
                        <section className="col-12"><Link to='/'>Công ty</Link></section>
                        <Divider />
                        <section className="col-12"><Link to={APP_LINK.listEvalutions}>Đánh giá</Link></section>
                        <Divider />
