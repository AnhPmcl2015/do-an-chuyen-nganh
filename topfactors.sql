create database topfactors;
ALTER DATABASE topfactors CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
use topfactors;

create table nation(
	id int2 auto_increment primary key,
...
create table app_user(
    ...
    email char(100),
    user_category_id int1 not null,
    company_id char(50),
    is_enable bit(1) default 0,
    avatar char(100)
);
...
create table type_of_business(
	id int3 auto_increment primary key,
...
create table company(
    ...
    working_time char(20) ,
    logo char(100) ,
    type_of_business_id int3,
...
create table recruitment_post(
    ...
    type_of_job_id int2 not null
);

create table type_of_job(
	id int2 auto_increment primary key,
    type_of_job_name nvarchar(30)
);
...
alter table recruitment_post add foreign key(type_of_job_id) references type_of_job(id);
...
-- user_otp
alter table user_otp add foreign key(user_id) references app_user(id);