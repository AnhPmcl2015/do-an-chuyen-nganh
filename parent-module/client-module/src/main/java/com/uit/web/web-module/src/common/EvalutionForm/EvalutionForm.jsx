 ...
 */
const EvalutionFormTemp = ({form, handleEvalutionForm}) => {
    ...
    const changeAbilityOfDevelopment = (e,editor) => {
        if(editor.getData().trim() === ''){
            let errorMess = ErrorMessage.blank.replace('%s', 'Khả năng phát triển');
            notification.error({
                message: 'Lỗi!',
    ...
    const changeCommunication = (e, editor) => {
        if(editor.getData().trim() === ''){
            let errorMess = ErrorMessage.blank.replace('%s', 'Khả năng giao tiếp');
            notification.error({
                message: 'Lỗi!',
                description: errorMess
            });
    ...
    const changeMajor = (e, editor) => {
        if(editor.getData().trim() === ''){
            let errorMess = ErrorMessage.blank.replace('%s', 'Chuyên môn');
            notification.error({
                message: 'Lỗi!',
                description: errorMess
            });
    ...
    const changeInput  = e => {
        let id = e.target.id.replace('evalution-form_', '');
        ...
        <Form className='evalution-form container-fluid'>
            <section className="row">
                <section className="col-md-6 col-12">
                    ...
                    <Form.Item>
                        ...
                        })(<Input onBlur={(e)=>changeInput(e)} className='evalution-form-input' type="text"/>)}
                    </Form.Item>
                </section>
            ...
            <section className='row'>
                <section className="col-12">
                    <label
                        htmlFor='evalution-form_currentCompany'
                        className='evalution-form-label'>Nơi công tác</label>
            ...
            <section className='row'>
                ...
                <section className="col-12">
                    <label
                        htmlFor='ability-of-development'
                        className='evalution-form-label'>Khả năng phát triển</label>
                ...
                <section className="col-12">
                    <label
                        htmlFor='other-evalution'
                        className='evalution-form-label'>Những đánh giá khác</label>
